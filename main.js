document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeAndAnimateShaders() {
        ...
        const panelConfigs = [
            { id: 'services', options: { color: [0.1, 0.5, 0.6], speed: 0.25, effect: 'MechanicGears' } },
            { id: 'why-us', options: { color: [0.85, 0.65, 0.1], speed: 0.2, effect: 'OilSlick' } },
            { id: 'news', options: { color: [0.35, 0.35, 0.4], speed: 0.2, effect: 'DiamondPlate' } },
            { id: 'video-promo', options: { color: [0.1, 0.3, 0.7], speed: 0.25, effect: 'HexGrille' } },
            { id: 'slideshow-section', options: { color: [0.9, 0.6, 0.1], speed: 0.3, effect: 'OilSlick' } },
            { id: 'videoplayer-section', options: { color: [0.2, 0.5, 0.65], speed: 0.3, effect: 'MechanicGears' } },
            { id: 'facts', options: { color: [0.3, 0.35, 0.45], speed: 0.25, effect: 'DiamondPlate' } },
            { id: 'engine-bay', options: { color: [0.9, 0.25, 0.05], speed: 0.2, effect: 'HexGrille' } },
            { id: 'service-area', options: { color: [0.15, 0.4, 0.55], speed: 0.2, effect: 'MechanicGears' } },
            { id: 'faq', options: { color: [0.2, 0.4, 0.55], speed: 0.2, effect: 'HexGrille' } }
        ];
    ...
    function populateProductsDropdown() {
        ...
        const baseProducts = [
            ...
            { name: 'Ordinary Motors x1', path: 'Products/x1.html' }
        ];
